...
export class MetricsListPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public http: HttpClient, public dataSet: DataEngineProvider) {
    this.dataSet.loadData('https://jsonplaceholder.typicode.com/posts?userId=1')
      .then(data => {
      this.metrics = data;
  ...
  public lineChartColors:Array<any> = [
    { // grey
      ...
      pointBorderColor: '#7271ff',
      pointHoverBackgroundColor: '#9898ff',
    ...
    { // dark grey
      ...
      pointBorderColor: '#ff5155',
      pointHoverBackgroundColor: '#ff7277',
